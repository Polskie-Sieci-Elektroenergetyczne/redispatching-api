...
sequenceDiagram
    ...
    REST Client->B2B REST API: GET psdi/api/v1/uoze
...
#### Adres Rest API
```
- POST psdi/api/v1/uoze
- GET psdi/api/v1/uoze/status
```
...
sequenceDiagram
    ...
    participant B2B REST API
    participant Backend service
    REST Client->B2B REST API: POST psdi/api/v1/uoze
    ...
    opt
      loop  
        REST Client->B2B REST API: GET psdi/api/v1/uoze/status

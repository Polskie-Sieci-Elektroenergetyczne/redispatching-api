...
#### Adres Rest API
```
- POST psdi/api/v1/restrictions
- GET psdi/api/v1/restrictions/status
```
...
sequenceDiagram
    ...
    REST Client->B2B REST API: POST psdi/api/v1/restrictions
    ...
    opt
      loop  
        REST Client->B2B REST API: GET psdi/api/v1/restrictions/status
